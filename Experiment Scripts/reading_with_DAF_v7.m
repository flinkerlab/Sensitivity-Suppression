...
function reading_with_DAF_v7(subject, block)
...
if blkn == 0
    ...
    DrawFormattedText(VidPtr, ['You will see a word on the screen.\n'...
        'Please read the word outloud.\n\n'...
...
for r = 1:nTrials
    ...
    % Draw text
    textSize = 90; Screen('TextSize', VidPtr ,textSize);
...
%     if r==1
%         audiodata(:,1:round(0.25*44100)) = 0;
%     end
